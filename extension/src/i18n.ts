...
const messages = {
  'zh-CN': {
    options: {
      title: '设置新标签页',
      subtitle: '主地址一般填内网地址，备用地址一般填外网地址。',
      ...
      fallbackUrlLabel: '备用地址',
      fallbackUrlPlaceholder: '例如 https://backup.example.com',
      fallbackUrlHint: '主地址打不开时，自动改用这个地址。',
      openModeLabel: '打开方式',
    ...
    newtab: {
      ...
      unconfiguredDescription: '先到设置页填写主地址和备用地址，再选择打开方式。',
      openSettingsButton: '打开配置页',
      noticeOpeningTitle: '正在打开导航页',
      noticeFallbackTitle: '已切换到备用地址',
      statusByReason: {
        primary: '主地址可用，正在打开导航页。',
        fallback: '主地址不可用，已自动切换到备用地址。',
        'primary-unverified': '无法验证主地址，已直接尝试打开。',
        'fallback-unverified': '已切换到备用地址，但扩展没有权限验证连通性。',
  ...
  en: {
    options: {
      ...
      subtitle: 'Use your LAN URL as primary and your WAN URL as fallback in most cases.',
      ...
      fallbackUrlPlaceholder: 'For example https://backup.example.com',
      fallbackUrlHint: 'Use this address if the primary one is unavailable.',
    ...
    newtab: {
      ...
      unconfiguredDescription:
        'Open settings, fill in the primary and fallback addresses, then choose how the page should open.',
      openSettingsButton: 'Open Settings',
      noticeOpeningTitle: 'Opening Smart Harbor',
      noticeFallbackTitle: 'Switched to fallback',
      statusByReason: {
        primary: 'Primary address is available. Opening Smart Harbor.',
        fallback: 'Primary address is unavailable. Switched to the fallback address.',
        'primary-unverified': 'The primary address could not be verified, so it is being opened directly.',
        'fallback-unverified':
          'Switched to the fallback address, but the extension cannot verify its availability.',
